...
import api.voll.med.api.domain.medico.DadosCadastroMedico;
...
import api.voll.med.api.domain.paciente.Paciente;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario2() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
        var medico = cadastrarMedico("Medico", "medico@voll.med", "123455", Especialidade.CARDIOLOGIA);
